...
export function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      setErrorMessage(err.message || "Invalid E-mail or password.");
      setErrorModalOpen(true);
      setPending(false);
    }
  };
    ...
    <div className="min-h-screen flex flex-col items-center p-6 bg-surface-light dark:bg-surface-dark relative">
      ...
      <div className="w-full max-w-sm mx-auto flex-1 flex flex-col justify-center z-10 py-12">
        <div className="flex flex-col items-center mb-10 text-center">
          ...
          <h1 className="text-3xl font-bold mb-2">Get back to your money!</h1>
          <p className="text-xl text-gray-600 dark:text-gray-400">Login to your account</p>
        </div>
