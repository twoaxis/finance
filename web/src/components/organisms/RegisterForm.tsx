...
export const RegisterForm: React.FC = () => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (hasFailedSubmit) validateField(name as keyof RegisterFieldsState, value)
  }
  ...
  const validateForm = () => {
    ...
    if (!form.repeatPassword) newErrors.repeatPassword = 'Please confirm your password'
  ...
  const isLockedOut =
    hasFailedSubmit && (!!errors.email || !!errors.password || !!errors.repeatPassword)
