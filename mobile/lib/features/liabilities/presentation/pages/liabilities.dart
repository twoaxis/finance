import 'package:twoaxis_finance/features/liabilities/presentation/widgets/liabilities_action_button.dart';
          ...
          Expanded(
            child: BlocBuilder<UserCubit, UserState>(
                builder: (context, state) {
                  ...
                  var liabilities = state.user.liabilities;
