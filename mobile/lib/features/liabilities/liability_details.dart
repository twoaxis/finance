...
import 'package:financial_planner_mobile/features/liabilities/liability_payment.dart';
...
class LiabilityDetails extends StatefulWidget {
  const LiabilityDetails(
      {super.key, required this.index, required this.liability});
                  ...
                  children: [
                    ...
                    Text(
                      formatMoneyWithContext(
                          context, widget.liability["value"]),
                      style: TextStyle(
                ...
                PrimaryButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => LiabilityPayment(
                          liability: widget.liability,
                          liabilityIndex: widget.index,
                        ),
                      ),
                    );
                  },
