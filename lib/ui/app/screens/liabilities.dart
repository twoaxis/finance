                          ...
                          children: [
                                  ...
                                  showDialog(context: context, builder: (BuildContext build) {
                                    return AlertDialog(
                                      ...
                                      content: Column(
                                        mainAxisSize: MainAxisSize.min,
                                        children: [
                                          if(errorPayment.isNotEmpty) Text(
                                            errorPayment,
                                            style: const TextStyle(
                                              color: Colors.red,
                                            ),
                                          ...
                                          onPressed: pending ? null : () async {
                                            ...
                                            try {
                                              if(valueController.text.isEmpty) {
                                                setState(() {
                                                  errorPayment = "Please fill the field";
                                                });
                                              }
                                              else {
                                                ...
                                                liabilities[index]["value"] -= int.parse(valueController.text);
                                              ...
                                              setState(() {
                                                errorPayment = "An error has occurred";
                                              });
                            ...
                            IconButton(
                                onPressed: () {
                                  showDialog(context: context, builder: (BuildContext build) {
                                    return AlertDialog(
                                      title: const Text("Are you sure to delete this liability?"),
                                        ...
                                        TextButton(
                                          onPressed: () {
                                            ...
                                            FirebaseFirestore.instance.collection("users").doc(FirebaseAuth.instance.currentUser?.uid).update({
                                              "liabilities": FieldValue.arrayRemove([liabilities[index]])
                                            });
                                          },
