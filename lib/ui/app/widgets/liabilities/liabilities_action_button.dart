...
class LiabilitiesActionButton extends StatefulWidget {
  ...
  @override
  State<LiabilitiesActionButton> createState() => _LiabilitiesActionButtonState();
}
                ...
                try {
                  if(nameController.text.isEmpty || valueController.text.isEmpty) {
                    ...
                    await FirebaseFirestore.instance.collection("users").doc(FirebaseAuth.instance.currentUser?.uid).update({
                      "liabilities": FieldValue.arrayUnion([{"name": nameController.text, "value": int.parse(valueController.text)}])
                    });
